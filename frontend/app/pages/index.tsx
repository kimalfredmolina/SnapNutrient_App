    ...
    <View className="items-center">
      <View style={{ width: SIZE, height: SIZE }}>
        ...
        <View className="absolute top-0 left-0 right-0 bottom-0 justify-center items-center">
          <Text className="text-xs font-black text-gray-800">{value}{unit}</Text>
        </View>
      </View>
  ...
  return (
    ...
    <ScrollView className="flex-1 bg-gray-50">
      ...
      <View className="flex-row justify-between items-center px-5 pt-16 pb-6">
        <Text className="text-xl font-bold text-gray-800">Welcome back / Guest</Text>
      ...
      {/* Scan & Discover Card */}
      <View className="bg-green-100 mx-5 rounded-2xl p-6 flex-row items-center mb-8">
        <View className="flex-1">
          <Text className="text-2xl font-black text-gray-800 mb-2">Scan & Discover</Text>
          ...
          <TouchableOpacity className="bg-[#a259ff] px-6 py-3 rounded-full self-start shadow-md">
            <Text className="text-white font-black text-sm">Start Scanning</Text>
          </TouchableOpacity>
        </View>
        <View className="ml-6">
      ...
      <View className="px-5 mb-8">
        <Text className="text-xl font-black text-gray-800 mb-6">Food Items</Text>
        <FoodItem 
      ...
      <View className="px-5 mb-28">
        <Text className="text-xl font-black text-gray-800 mb-6">Today's Nutrition</Text>
